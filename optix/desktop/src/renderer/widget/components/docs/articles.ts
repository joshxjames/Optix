...
export const DOC_ARTICLES: DocArticle[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    blocks: [
      ...
      {
        kind: 'note',
        text: "Diagnostic info (app version, OS, active provider, IP) is included automatically so we can reproduce issues faster. If the in-app send fails, the form will offer a one-click fallback to open your email client with the same message pre-filled.",
      },
    ],
  },
];
